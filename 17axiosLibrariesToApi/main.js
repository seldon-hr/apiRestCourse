...
async function saveFavouriteDog(id) {
    ...
    /* 
        Here, we passed from the common use of 'fetch' ⬇, to use the axios library ⬆, we use the axios method
        and those transform in JSON, but remmber to define the instnace to could create this kind of requests.
        As we made it in the number 2 line.
    */
